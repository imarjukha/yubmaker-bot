...
TEAM_FOR_REPORT = [
    ("Анна Смирнова", "anna_smirnova", 99761883),
    ("Ольга Юрьева", "olga_yureva", 99763886),
    ("Екатерина", "kataz0601", 99844168),
    ("Мария Зеленова", "maria_zelenova", 99761884),
    ("Никита Акимушкин", "nikita_akimushkin", 99761882),
    ("Полина Заботина", "polina_zabotina", 99761939),
    ("Тамара Панченко", "tamara_panchenko", 99763894),
    ("Астемир Русланович", "astemir", 99761885),
]
